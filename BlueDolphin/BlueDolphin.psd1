@{
    ...
    FunctionsToExport = @('Connect-BlueDolphin','Disconnect-Bluedolphin','Test-BlueDolphinConnection','Get-BDInformation','Get-BDObject','Get-BDParentObject','Get-BDRelation')
