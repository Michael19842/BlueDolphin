@{
    ...
    FunctionsToExport = @('Connect-BlueDolphin','Disconnect-Bluedolphin','Test-BlueDolphinConnection','Get-BDInformation','Get-BDObject','Get-BDRelatedObject','Get-BDRelation')
